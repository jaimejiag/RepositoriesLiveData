...
public class AppInjector {
    ...
    public static void init(RepositoriesApplication repositoriesApplication) {
        DaggerAppComponent.builder().application(repositoriesApplication)
                .build().inject(repositoriesApplication);


        repositoriesApplication.registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
            @Override
